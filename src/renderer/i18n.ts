...
export const en = {
  ...
  summary_retry_save: 'Save to another location',
  ...
  summary_error_save_failed: 'The document could not be written. It is still held in memory, so you can save it elsewhere without paying again.',
...
export const fr: Record<I18nKey, string> = {
  ...
  summary_retry_save: 'Enregistrer à un autre emplacement',
