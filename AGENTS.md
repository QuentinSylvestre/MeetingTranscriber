...
Run tests from the repo root: `npm test` (rebuilds `better-sqlite3` for Node first; do not run `vitest` directly as the native addon won't be built for the right target).
